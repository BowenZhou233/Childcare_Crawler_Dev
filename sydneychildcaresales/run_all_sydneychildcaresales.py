...
STEPS = {
    2: ("Collect listing URLs",  "02_crawl_all_listings_sydneychildcaresales.py"),
    3: ("Extract detail pages",  "03_extract_details_sydneychildcaresales.py"),
    4: ("Export CSV/Excel",      "04_export_sydneychildcaresales.py"),
}
