...
Input:  data/childcare_raw_sydneychildcaresales.json
...
def main():
    input_path  = "data/childcare_raw_sydneychildcaresales.json"
    csv_path    = "data/childcare_data_sydneychildcaresales.csv"
    excel_path  = "data/childcare_data_sydneychildcaresales.xlsx"

    if not os.path.exists(input_path):
        print(f"ERROR: {input_path} not found. Run 03_extract_details_sydneychildcaresales.py first.")
        return
